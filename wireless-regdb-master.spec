...
export LANG=C
export SOURCE_DATE_EPOCH=1523111800
make  %{?_smp_mflags} PYTHON=/usr/bin/python2 install PREFIX=%{buildroot}/tmp  FIRMWARE_PATH=%{buildroot}/usr/lib/firmware LSB_ID="clr"
...
%files
%defattr(-,root,root,-)
/builddir/build/BUILDROOT/wireless-regdb-master-2017.12.23-1.x86_64/usr/lib/firmware/regulatory.db
/builddir/build/BUILDROOT/wireless-regdb-master-2017.12.23-1.x86_64/usr/lib/firmware/regulatory.db.p7s
